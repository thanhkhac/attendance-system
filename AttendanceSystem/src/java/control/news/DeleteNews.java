...
public class DeleteNews extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (deleteReuslt) {
                redirectURL += "?successMessage=" + URLEncoder.encode("News delete updated!", "UTF-8");
            } else {
                redirectURL += "?errorMessage=" + URLEncoder.encode("Failed to delete news. Please try again.", "UTF-8");
            }
