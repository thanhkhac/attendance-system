 ...
 * @author ADMIN-PC
 */
public class GetInfoNews extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GetInfoNews</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GetInfoNews at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (newIdParam != null && !newIdParam.isEmpty()) {
            try {
                ...
                List<EmployeeDTO> optionCreateBy = newdao.findAllEmployees();
                request.setAttribute("employees", optionCreateBy);
                request.setAttribute("newsupdate", newdto);
