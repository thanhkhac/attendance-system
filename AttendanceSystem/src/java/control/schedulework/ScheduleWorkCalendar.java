...
@WebServlet(name="ScheduleWorkCalendar", urlPatterns={"/ScheduleWorkCalendar"})
public class ScheduleWorkCalendar extends HttpServlet {
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("ScheduleWorkCalendar.jsp").forward(request, response);
    } 
