...
@WebServlet(name = "ScheduledEmployeeList", urlPatterns = {"/ScheduledEmployeeList"})
public class ScheduledEmployeeList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("ScheduledEmployeeList.jsp").forward(request, response);
    }
